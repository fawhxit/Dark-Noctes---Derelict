	...
	set = {
		...
		*/
		...
		node : {
			...
			// n0: init_node([ww2,wh2],"Market",verb2.move,rCol_10,rCol_20,self), // UPDATE ME
			// n1: init_node([ww2,wh2],"To Forest",verb2.move,rCol_00,rBT0,self),  // UPDATE ME
			n2: init_node([ww2,wh2],"To Comm-Market Corridor",verb2.move,rCol_50,rCol_40,self)  // UPDATE ME
