...
#region Create Struct
	...
	set = {
		...
		node : {
			...
			n0: init_node([ww2,wh2],"Thru Doorway",verb2.move,in_room,rBunker16,self), // UPDATE ME
			n1: init_node([ww2,wh2],"Back to Corridors",verb2.move,in_room,rBunker10,self),  // UPDATE ME
			n3: init_node([ww2,wh2],"Workstation",verb2.move,in_room,rBunker15,self)  // UPDATE ME
