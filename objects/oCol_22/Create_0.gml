	...
	set = {
		...
		*/
		...
		node : {
			...
			n0: init_node([ww2,wh2],"To Manufacturing",verb2.move,rCol_22,rCol_14,self), // UPDATE ME
			// n1: init_node([ww2,wh2],"To Forest",verb2.move,rCol_00,rBT0,self),  // UPDATE ME
			n2: init_node([ww2,wh2],"To Market-Dorm Corridor",verb2.move,rCol_22,rCol_32,self)  // UPDATE ME
