	...
	set = {
		...
		start : {
			...
			#region str0
				...
				str0 : "WARNING: Tutorial data corrupted (Ex00069)",
		
			#endregion
		
			#region str1
			
				str1 : "Good luck commander."
		...
		node : {
			...
			n0: init_node([ww2,wh2],"To Colony",verb2.move,rCol_00,rCol_10,self), // UPDATE ME
			n1: init_node([ww2,wh2],"To Forest",verb2.move,rCol_00,rBT0,self),  // UPDATE ME
			n2: init_node([ww2,wh2],"To Quarry",verb2.move,rCol_00,rQua0,self)  // UPDATE ME
