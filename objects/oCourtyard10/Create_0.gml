...
#region Create Struct
	...
	set = {
		...
		node : {
			...
			n0: init_node([ww2,wh2],"Kitchen",verb2.move,in_room,rCourtyard11,self), // UPDATE ME
			n1: init_node([ww2,wh2],"Warehouse",verb2.move,in_room,rCourtyard9,self)  // UPDATE ME
