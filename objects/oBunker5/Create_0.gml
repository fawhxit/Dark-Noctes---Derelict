...
#region Create Struct
	...
	set = {
		...
		node : {
			...
			n0: init_node([ww2,wh2],"Caged Area Ahead",verb2.move,in_room,rBunker7,self), // UPDATE ME
			n1: init_node([ww2,wh2],"Back",verb2.move,in_room,rBunker4,self),  // UPDATE ME
			n3: init_node([ww2,wh2],"Right to Doorway",verb2.move,in_room,rBunker6,self)  // UPDATE ME
				
		},
	
		entity : {
		
			e0: init_entity([ww2,wh2],"Crowbar",ent.weapon,rBunker5,self)
...
#region Entity Updatees
	...
	with(set.entity.e0) {
		...
		yy = parent.set.h*ypct
		spr = sprCrowbar
		sprRot = random_range(85,95)
		if(chance(50)) sprRot = random_range(265,275)
		state = ent.weapon
		durability = 3
