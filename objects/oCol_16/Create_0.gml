	...
	set = {
		...
		*/
		...
		node : {
			...
			// n0: init_node([ww2,wh2],"To Lounge & Recreation",verb2.move,rCol_10,rCol_20,self), // UPDATE ME
			// n1: init_node([ww2,wh2],"To Forest",verb2.move,rCol_00,rBT0,self),  // UPDATE ME
			n2: init_node([ww2,wh2],"To Manufacturing",verb2.move,rCol_16,rCol_14,self)  // UPDATE ME
