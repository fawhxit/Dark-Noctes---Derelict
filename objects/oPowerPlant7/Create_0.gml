...
#region Create Struct
	...
	set = {
		...
		node : {
			...
			n0: init_node([ww2,wh2],"Thru Vault",verb2.move,in_room,rPowerPlant8,self), // UPDATE ME
			n1: init_node([ww2,wh2],"Go Back",verb2.move,in_room,rPowerPlant1,self),  // UPDATE ME
