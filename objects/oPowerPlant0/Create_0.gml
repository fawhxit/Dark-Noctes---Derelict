...
#region Create Struct
	...
	set = {
		...
		node : {
			...
			n0: init_node([ww2,wh2],"Corridor",verb2.move,in_room,rPowerPlant1,self), // UPDATE ME
			n1: init_node([ww2,wh2],"Back Outside",verb2.move,in_room,rCourtyard8,self),  // UPDATE ME
