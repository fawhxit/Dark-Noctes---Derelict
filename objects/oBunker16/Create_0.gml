...
#region Create Struct
	...
	set = {
		...
		node : {
			...
			n0: init_node([ww2,wh2],"Go Outside",verb2.move,in_room,rCourtyard0,self), // UPDATE ME TODOTODOTODO
			n1: init_node([ww2,wh2],"Back to Workstations",verb2.move,in_room,rBunker14,self),  // UPDATE ME
