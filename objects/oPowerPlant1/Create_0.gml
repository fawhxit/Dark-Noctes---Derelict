...
#region Create Struct
	...
	set = {
		...
		node : {
			...
			n0: init_node([ww2,wh2],"Corridor Ahead",verb2.move,in_room,rPowerPlant7,self), // UPDATE ME
			n1: init_node([ww2,wh2],"Back to Foyer",verb2.move,in_room,rPowerPlant0,self),  // UPDATE ME
			n2: init_node([ww2,wh2],"Corridor Left",verb2.move,in_room,rPowerPlant3,self),  // UPDATE ME
			n3: init_node([ww2,wh2],"Corridor Right",verb2.move,in_room,rPowerPlant2,self)  // UPDATE ME
