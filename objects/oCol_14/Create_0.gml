	...
	set = {
		...
		*/
		...
		node : {
			...
			n0: init_node([ww2,wh2],"To Waste Processing",verb2.move,rCol_14,rCol_16,self), // UPDATE ME
			n1: init_node([ww2,wh2],"To Market-Dorm",verb2.move,rCol_14,rCol_22,self),  // UPDATE ME
			n2: init_node([ww2,wh2],"To Refinery",verb2.move,rCol_14,rCol_12,self)  // UPDATE ME
