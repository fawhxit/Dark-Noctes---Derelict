...
#region Create Struct
	...
	set = {
		...
		node : {
			...
			n0: init_node([ww2,wh2],"To Garage",verb2.move,in_room,rCourtyard14,self), // UPDATE ME
			n1: init_node([ww2,wh2],"Back Outside",verb2.move,in_room,rCourtyard2,self),  // UPDATE ME
