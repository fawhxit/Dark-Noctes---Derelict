...
#region Create Struct
	...
	set = {
		...
		node : {
			...
			n0: init_node([ww2,wh2],"Take Truck",verb2.move,in_room,rFin,self), // UPDATE ME
			n1: init_node([ww2,wh2],"Back",verb2.move,in_room,rCourtyard13,self),  // UPDATE ME
			//n2: init_node([ww2,wh2],"NEXT LEFT",verb2.move,in_room,NEXTL_TODO,self),  // UPDATE ME
			//n3: init_node([ww2,wh2],"NEXT RIGHT",verb2.move,in_room,NEXTR_TODO,self)  // UPDATE ME
	...
	if(M.dbgEnd) {
		...
		set.entity.e0 = init_entity([ww2,wh2],"Keys",ent.normal,in_room,self)
