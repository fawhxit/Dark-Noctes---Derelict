...
#region Create Struct
	...
	set = {
		...
		node : {
			...
			n0: init_node([ww2,wh2],"To Bunker",verb2.move,in_room,rBT3,self),
			n1: init_node([ww2,wh2],"Go Back",verb2.move,in_room,rBT1,self)
	...
	if(M.gvs.bunkerCard == 1) {
		...
		set.entity.e0 = init_entity([ww2,wh2],"White Keycard",ent.normal,in_room,self)
