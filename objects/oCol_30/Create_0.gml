	...
	set = {
		...
		*/
		...
		node : {
			...
			n0: init_node([ww2,wh2],"Comm-Market Corridor",verb2.move,rCol_30,rCol_40,self), // UPDATE ME
			n1: init_node([ww2,wh2],"Botany Corridor",verb2.move,rCol_30,rCol_31,self),  // UPDATE ME
			n2: init_node([ww2,wh2],"To Lounge & Recreation",verb2.move,rCol_30,rCol_20,self),  // UPDATE ME
			n3: init_node([ww2,wh2],"Dormitory Corridor",verb2.move,rCol_30,rCol_32,self)  // UPDATE ME
