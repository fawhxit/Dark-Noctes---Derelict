	...
	set = {
		...
		*/
		...
		node : {
			...
			n0: init_node([ww2,wh2],"To Manufacturing",verb2.move,rCol_12,rCol_14,self), // UPDATE ME
			// n1: init_node([ww2,wh2],"To Forest",verb2.move,rCol_00,rBT0,self),  // UPDATE ME
			n2: init_node([ww2,wh2],"To Terminal",verb2.move,rCol_12,rCol_10,self)  // UPDATE ME
