...
#region Create Struct
	...
	set = {
		...
		node : {
			...
			n0: init_node([ww2,wh2],"Futher Down Corridor",verb2.move,in_room,rBunker14,self), // UPDATE ME
			n1: init_node([ww2,wh2],"Back to Storage Area",verb2.move,in_room,rBunker9,self),  // UPDATE ME
			n2: init_node([ww2,wh2],"Go Thru Left Doorway",verb2.move,in_room,rBunker12,self),  // UPDATE ME
			n3: init_node([ww2,wh2],"Go Thru Right Doorway",verb2.move,in_room,rBunker11,self)  // UPDATE ME
