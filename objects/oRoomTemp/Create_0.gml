...
#region Create Struct
	...
	set = {
		...
		node : {
			...
			n0: init_node([ww2,wh2],"UPDATE ME",verb2.move,in_room,undefined,self), // UPDATE ME
			n1: init_node([ww2,wh2],"UPDATE ME",verb2.move,in_room,undefined,self)  // UPDATE ME
