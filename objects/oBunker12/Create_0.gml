...
#region Create Struct
	...
	set = {
		...
		node : {
			...
			n0: init_node([ww2,wh2],"Forward Past Machinery",verb2.move,in_room,rBunker13,self), // UPDATE ME
			n3: init_node([ww2,wh2],"Right Back to Corridors",verb2.move,in_room,rBunker10,self)  // UPDATE ME
