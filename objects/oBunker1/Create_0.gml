...
#region Create Struct
	...
	set = {
		...
		node : {
			...
			n0: init_node([ww2,wh2],"End of Hall",verb2.move,in_room,rBunker2,self), // UPDATE ME
			n1: init_node([ww2,wh2],"Back down Hall",verb2.move,in_room,rBunker0,self),  // UPDATE ME
			n3: init_node([ww2,wh2],"Hall Right",verb2.move,in_room,rBunker3,self)  // UPDATE ME
