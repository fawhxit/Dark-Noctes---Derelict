...
#region Create Struct
	...
	set = {
		...
		node : {
			...
			n0: init_node([ww2,wh2],"Ahead",verb2.move,in_room,rLab2,self), // UPDATE ME
			n1: init_node([ww2,wh2],"Exit",verb2.move,in_room,rCourtyard7,self),  // UPDATE ME
			n2: init_node([ww2,wh2],"Left Doorway",verb2.move,in_room,rLab1,self)  // UPDATE ME
