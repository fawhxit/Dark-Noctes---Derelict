...
#region Create Struct
	...
	set = {
		...
		node : {
			...
			n0: init_node([ww2,wh2],"Enter Depot",verb2.move,in_room,rCourtyard13,self), // UPDATE ME
			n1: init_node([ww2,wh2],"Back",verb2.move,in_room,rCourtyard1,self)  // UPDATE ME
