...
#region Create Struct
	...
	set = {
		...
		node : {
			...
			n0: init_node([ww2,wh2],"Ahead Thru Vault",verb2.move,in_room,rBunker4,self), // UPDATE ME
			n1: init_node([ww2,wh2],"Back to Hall",verb2.move,in_room,rBunker1,self),  // UPDATE ME
			n2: init_node([ww2,wh2],"Closed Blastdoor",verb2.move,in_room,noone,self) // UPDATE ME
