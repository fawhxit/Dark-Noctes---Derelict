...
#region Create Struct
	...
	set = {
		...
		node : {
			...
			n0: init_node([ww2,wh2],"Down Hallway",verb2.move,in_room,rLab10,self), // UPDATE ME
			n1: init_node([ww2,wh2],"Back",verb2.move,in_room,rLab7,self),  // UPDATE ME
			n2: init_node([ww2,wh2],"Door",verb2.move,in_room,rLab9,self)  // UPDATE ME
