...
#region Create Struct
	...
	set = {
		...
		node : {
			...
			n0: init_node([ww2,wh2],"Ahead Thru Storage Area",verb2.move,in_room,rBunker10,self), // UPDATE ME
			n1: init_node([ww2,wh2],"Back to Hallway",verb2.move,in_room,rBunker4,self)  // UPDATE ME
