	...
	set = {
		...
		*/
		...
		node : {
			...
			n0: init_node([ww2,wh2],"Enter Command",verb2.move,rCol_40,rCol_50,self), // UPDATE ME
			n1: init_node([ww2,wh2],"To Medical",verb2.move,rCol_40,rCol_41,self),  // UPDATE ME
			n2: init_node([ww2,wh2],"To Market",verb2.move,rCol_40,rCol_30,self),  // UPDATE ME
			n3: init_node([ww2,wh2],"To Power Plant",verb2.move,rCol_40,rCol_42,self)  // UPDATE ME
