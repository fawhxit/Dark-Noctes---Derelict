...
#region Create Struct
	...
	set = {
		...
		node : {
			...
			n0: init_node([ww2,wh2],"Behind Pipeworks",verb2.move,in_room,rPowerPlant5,self), // UPDATE ME
			n1: init_node([ww2,wh2],"Back",verb2.move,in_room,rPowerPlant3,self),  // UPDATE ME
