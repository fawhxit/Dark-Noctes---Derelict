...
#region Create Struct
	...
	set = {
		...
		node : {
			...
			n0: init_node([ww2,wh2],"Tunnel",verb2.move,in_room,rCourtyard4,self), // UPDATE ME
			n1: init_node([ww2,wh2],"Up through Floorboards",verb2.move,in_room,rBunker6,self),  // UPDATE ME
