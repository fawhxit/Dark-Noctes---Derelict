...
#region Create Struct
	...
	set = {
		...
		node : {
			...
			n0: init_node([ww2,wh2],"Thru Empty Doorway",verb2.move,in_room,rBunker8,self), // UPDATE ME
			n1: init_node([ww2,wh2],"Back out from Caged Area",verb2.move,in_room,rBunker5,self),  // UPDATE ME
