...
#region Create Struct
	...
	set = {
		...
		node : {
			...
			n0: init_node([ww2,wh2],"Backroom",verb2.move,in_room,rCourtyard10,self), // UPDATE ME
			n1: init_node([ww2,wh2],"Outside",verb2.move,in_room,rCourtyard6,self),  // UPDATE ME
