...
#region Create Struct
	...
	set = {
		...
		node : {
			...
			n1: init_node([ww2,wh2],"Back",verb2.move,in_room,rLab4,self),  // UPDATE ME
			n2: init_node([ww2,wh2],"Left",verb2.move,in_room,rLab6,self),  // UPDATE ME
			//n3: init_node([ww2,wh2],"Right",verb2.move,in_room,rLab8,self)  // UPDATE ME
