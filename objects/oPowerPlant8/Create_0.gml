...
#region Create Struct
	...
	set = {
		...
		node : {
			...
			n0: init_node([ww2,wh2],"Thru Airlock",verb2.move,in_room,rPowerPlant9,self), // UPDATE ME
			n1: init_node([ww2,wh2],"Thru Vault",verb2.move,in_room,rPowerPlant7,self),  // UPDATE ME
			n2: init_node([ww2,wh2],"Left Doorway",verb2.move,in_room,rPowerPlant11,self),  // UPDATE ME
